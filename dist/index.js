import {z as z$1,A,t,y,N,M,E,C,R,G as G$1,w,b,u,v,B,c,e,s,a,f,g,j as j$1,k,l,m,x}from'./chunk-VBVIH4HZ.js';var Xt=new Set(["role","name","aria-label","rel","href"]);function Kt(t,e){let n=Xt.has(t);n||=t.startsWith("data-")&&K(t);let i=K(e)&&e.length<100;return i||=e.startsWith("#")&&K(e.slice(1)),n&&i}function qt(t){return K(t)}function Ut(t){return K(t)}function Wt(t){return  true}function dt(t,e){if(t.nodeType!==Node.ELEMENT_NODE)throw new Error("Can't generate CSS selector for non-element node type.");if(t.tagName.toLowerCase()==="html")return "html";let n={root:document.body,idName:qt,className:Ut,tagName:Wt,attr:Kt,timeoutMs:1e3,seedMinLength:3,optimizedMinLength:2,maxNumberOfPathChecks:1/0},i=new Date,o={...n,...e},r=Zt(o.root,n),s,a=0;for(let p of Yt(t,o,r)){if(new Date().getTime()-i.getTime()>o.timeoutMs||a>=o.maxNumberOfPathChecks){let u=Vt(t,r);if(!u)throw new Error(`Timeout: Can't find a unique selector after ${o.timeoutMs}ms`);return q(u)}if(a++,Me(p,r)){s=p;break}}if(!s)throw new Error("Selector was not found.");let l=[...ft(s,t,o,r,i)];return l.sort(Le),l.length>0?q(l[0]):q(s)}function*Yt(t,e,n){let i=[],o=[],r=t,s=0;for(;r&&r!==n;){let a=Gt(r,e);for(let l of a)l.level=s;if(i.push(a),r=r.parentElement,s++,o.push(...ht(i)),s>=e.seedMinLength){o.sort(Le);for(let l of o)yield l;o=[];}}o.sort(Le);for(let a of o)yield a;}function K(t){if(/^[a-z\-]{3,}$/i.test(t)){let e=t.split(/-|[A-Z]/);for(let n of e)if(n.length<=2||/[^aeiou]{4,}/i.test(n))return  false;return  true}return  false}function Gt(t,e){let n=[],i=t.getAttribute("id");i&&e.idName(i)&&n.push({name:"#"+CSS.escape(i),penalty:0});for(let s=0;s<t.classList.length;s++){let a=t.classList[s];e.className(a)&&n.push({name:"."+CSS.escape(a),penalty:1});}for(let s=0;s<t.attributes.length;s++){let a=t.attributes[s];e.attr(a.name,a.value)&&n.push({name:`[${CSS.escape(a.name)}="${CSS.escape(a.value)}"]`,penalty:2});}let o=t.tagName.toLowerCase();if(e.tagName(o)){n.push({name:o,penalty:5});let s=Re(t,o);s!==void 0&&n.push({name:ut(o,s),penalty:10});}let r=Re(t);return r!==void 0&&n.push({name:Jt(o,r),penalty:50}),n}function q(t){let e=t[0],n=e.name;for(let i=1;i<t.length;i++){let o=t[i].level||0;e.level===o-1?n=`${t[i].name} > ${n}`:n=`${t[i].name} ${n}`,e=t[i];}return n}function ct(t){return t.map(e=>e.penalty).reduce((e,n)=>e+n,0)}function Le(t,e){return ct(t)-ct(e)}function Re(t,e){let n=t.parentNode;if(!n)return;let i=n.firstChild;if(!i)return;let o=0;for(;i&&(i.nodeType===Node.ELEMENT_NODE&&(e===void 0||i.tagName.toLowerCase()===e)&&o++,i!==t);)i=i.nextSibling;return o}function Vt(t,e){let n=0,i=t,o=[];for(;i&&i!==e;){let r=i.tagName.toLowerCase(),s=Re(i,r);if(s===void 0)return;o.push({name:ut(r,s),penalty:NaN,level:n}),i=i.parentElement,n++;}if(Me(o,e))return o}function Jt(t,e){return t==="html"?"html":`${t}:nth-child(${e})`}function ut(t,e){return t==="html"?"html":`${t}:nth-of-type(${e})`}function*ht(t,e=[]){if(t.length>0)for(let n of t[0])yield*ht(t.slice(1,t.length),e.concat(n));else yield e;}function Zt(t,e){return t.nodeType===Node.DOCUMENT_NODE?t:t===e.root?t.ownerDocument:t}function Me(t,e){let n=q(t);switch(e.querySelectorAll(n).length){case 0:throw new Error(`Can't select any node with this selector: ${n}`);case 1:return  true;default:return  false}}function*ft(t,e,n,i,o){if(t.length>2&&t.length>n.optimizedMinLength)for(let r=1;r<t.length-1;r++){if(new Date().getTime()-o.getTime()>n.timeoutMs)return;let a=[...t];a.splice(r,1),Me(a,i)&&i.querySelector(q(a))===e&&(yield a,yield*ft(a,e,n,i,o));}}var Qt=["role","aria-label","type","name","href","src","data-testid","data-id"];function en(t){let e=5381;for(let n=0;n<t.length;n++)e=(e<<5)+e+t.charCodeAt(n)|0;return (e>>>0).toString(36)}function Pe(t){let e=t.children.length,n=0,i=t.parentElement;if(i)for(let s of i.children){if(s===t)break;s.tagName===t.tagName&&n++;}let o=[];for(let s of Qt){let a=t.getAttribute(s);a&&o.push(`${s}=${a}`);}let r=o.length>0?en(o.join(",")):"0";return `${e}:${n}:${r}`}function mt(t,e){let n=e.split(":");if(n.length!==3)return 0;let[i,o,r]=n,s=Number(i),a=Number(o);if(Number.isNaN(s)||Number.isNaN(a))return 0;let l=Pe(t),[p,d,u]=l.split(":"),c=0,m=Math.abs(Number(p)-s);m===0?c+=.2:m<=2?c+=.1:m<=5&&(c+=.03);let x=Math.abs(Number(d)-a);return x===0?c+=.4:x===1?c+=.2:x<=3&&(c+=.08),u===r&&(c+=.4),c}function j(t,e){let n=e==="before"?"previousElementSibling":"nextElementSibling",i=t[n],o=3;for(;i&&o>0;){let r=i.textContent?.trim();if(r)return e==="before"?r.slice(-32):r.slice(0,32);i=i[n],o--;}return ""}function re(t){let e=t.previousElementSibling?.textContent?.trim().slice(0,40)??"",n=t.nextElementSibling?.textContent?.trim().slice(0,40)??"";return [e,n].filter(Boolean).join(" | ")}function bt(t){if(t.id){let i=t.id.includes("'")?`concat('${t.id.replace(/'/g,`',"'",'`)}')`:`'${t.id}'`;return `//${t.localName}[@id=${i}]`}let e=[],n=t;for(;n&&n!==document.body&&e.length<6;){let i=n.localName,o=n.parentElement;if(n.id){let s=n.id.includes("'")?`concat('${n.id.replace(/'/g,`',"'",'`)}')`:`'${n.id}'`;return e.unshift(`/${i}[@id=${s}]`),"/"+e.join("")}let r=1;if(o)for(let s of o.children){if(s===n)break;s.localName===i&&r++;}e.unshift(`/${i}[${r}]`),n=o;}return "/html/body"+e.join("")}var U="data-feedback-anchor";function Fe(t){let e=dt(t,{className:u=>!/^(css|sc|emotion|styled)-/.test(u)&&!/^[a-z]{1,3}[A-Za-z0-9]{4,8}$/.test(u),attr:u=>["data-testid","data-id","role","aria-label"].includes(u),idName:u=>!u.startsWith("radix-")&&!/^:r[0-9]+:$/.test(u),seedMinLength:3,optimizedMinLength:2}),n=bt(t),o=(t.textContent?.trim()??"").slice(0,120),r=j(t,"before"),s=j(t,"after"),a=Pe(t),l=re(t),d=t.closest(`[${U}]`)?.getAttribute(U)??null;return {cssSelector:e,xpath:n,textSnippet:o,textPrefix:r,textSuffix:s,fingerprint:a,neighborText:l,elementTag:t.tagName,elementId:t.id||void 0,anchorKey:d}}function gt(t,e){let n=t.getBoundingClientRect();return n.left<=e.x&&n.top<=e.y&&n.right>=e.x+e.width&&n.bottom>=e.y+e.height}function yt(t,e=document.documentElement){let n=t.x+t.width/2,i=t.y+t.height/2,o=document.elementFromPoint(n,i);if(!o||o===e)return document.body;let r=o;for(;r&&r!==document.body;){if(r.hasAttribute(U)&&gt(r,t))return r;r=r.parentElement;}for(r=o;r&&r!==document.body;){if(gt(r,t))return r;r=r.parentElement;}return document.body}function vt(t,e){return e.width<=0||e.height<=0?{xPct:0,yPct:0,wPct:1,hPct:1}:{xPct:(t.x-e.x)/e.width,yPct:(t.y-e.y)/e.height,wPct:t.width/e.width,hPct:t.height/e.height}}var tn={question:"type.question",change:"type.change",bug:"type.bug",other:"type.other"};function nn(){let t=navigator.userAgentData;return t?t.platform==="macOS":navigator.platform?.includes("Mac")??/Macintosh|Mac OS X/i.test(navigator.userAgent)}var ae=class{constructor(e,n){this.colors=e;this.t=n;this.root=b("div",{style:`
        position:fixed;
        z-index:${2147483647};
        width:300px;
        padding:16px;
...
`;function Be(t){return `
    ...
    *, *::before, *::after {
    ...
    ${R}
    ${G$1}
  `}var An=120,Ln=80,we=class{constructor(e,n="en"){this.colors=e;this.locale=n;this.root=b("div",{style:`
        position: fixed;
        z-index: ${2147483647};
        max-width: 280px;
        padding: 12px 14px;
